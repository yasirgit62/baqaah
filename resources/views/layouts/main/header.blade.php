...
<head>
	...
	<link rel="icon" type="image/png" href="{{url('/assets_front/images/logo.png')}}" sizes="16x16">
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:300,400italic,400,600,600italic,700,800,800italic" rel="stylesheet" type="text/css">
	<link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="{{url('/assets_front/css/custom.css')}}" type="text/css" />
			...
			<div class="container siteheader-container">
				...
				<div class="logo-container hasInfoCard logosize--yes">
					...
					<h1 class="site-logo logo" id="logo">
						<a href="index.html" title="">
							<img src="{{url('/assets_front/images/white-logo.png')}}" class="logo-img" alt="" title="" />
						</a>
					</h1>
					<!--/ Logo -->
				</div>
				...
				<div id="main-menu" class="main-nav zn_mega_wrapper ">
					<ul id="menu-main-menu" class="main-menu zn_mega_menu">
						<li class="menu-item-has-children menu-item-mega-parent active"><a href="{{url('/main/home')}}">HOME</a></li>
						<li class="menu-item-has-children menu-item-mega-parent"><a href="#">FLORISTS</a>
						...
						<li class="menu-item-has-children"><a href="#">ABOUT</a>
							<ul class="sub-menu clearfix">
								...
								<li><a href="#">FLOWERS LIST</a></li>
								<li><a href="#">CONFIRMATION</a></li>
								<li><a href="#">CART</a></li>
							</ul>
						</li>
						<li class="menu-item-has-children menu-item-mega-parent"><a href="#">CONTACT</a></li>
					</ul>
				</div>
				<!--/ main menu -->
